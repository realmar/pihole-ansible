...
namespace JulianSchoenbaechler.MicDecode
{
    ...
    public class MicDecode : MonoBehaviour
    {
        ...
        public string InputDevice
        {
            ...
            {
                _inputDevice = value;
                PlayerPrefs.SetString(NoiseCollector.SELECTED_MICROPHONE, value);
            }
        }
        ...
        protected void Start()
        {
            ...
            if (PlayerPrefs.HasKey(NoiseCollector.SELECTED_MICROPHONE))
            {
                _inputDevice = PlayerPrefs.GetString(NoiseCollector.SELECTED_MICROPHONE);
            }
        }
